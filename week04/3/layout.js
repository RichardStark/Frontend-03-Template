function getStyle(element) {
  ...
  for (let prop in element.cumputedStyle) {
    var p = element.cumputedStyle.value;
    element.style[prop] = element.cumputedStyle[prop].value;
    ...
    flexLines.forEach(function (items) {
      ...
      if (flexTotal > 0) {
        ...
        if (style.justifyContent === "flex-end") {
          var currentMain = mainBase * mainSigh * mainSpace;
          var step = 0
        }
